...
<body>
        ...
        <div style="display:flex; align-items:center;">
            ...
            <nav>
                ...
                <?php else: ?>
                    ...
                    <a href="signinS.php">For Staff and Admin </a>
                <?php endif; ?>
            </nav>
        </div>
    </header>
    ...
    <section id="home" class="hero">
        <img src="../Customer/image/backgroundhome.png" alt="Game Background" class="bg-image">
        <div class="hero-text">
            <!-- 修正后的 Hero H1 和 Image 结构 -->
            <div>
                <h1>Welcome to DJS Game</h1><img src="../Customer/image/logo.png" alt="DJS Logo Element" class="hero-image-logo">
            </div>
    ...
    <section id="topup" class="topup-games container">
        ...
        <div class="game-list">
            ...
            <div class="game-card">
                <img src="../Customer/image/genshin.webp" alt="Genshin Impact">
                <h3>Genshin Impact</h3>
            </div>
            <div class="game-card">
                <img src="../Customer/image/hsr.png" alt="Honkai Star Rail">
                <h3>Honkai: Star Rail</h3>
            </div>
            <div class="game-card">
                <img src="../Customer/image/wuwa.png" alt="Wuthering Waves">
    ...
    <section class="payment">
        <div class="container">
            ...
            <div class="payment-logos">
                ...
                <img src="../Customer/image/mastercard.webp" alt="Mastercard">
                <img src="../Customer/image/visa.png" alt="Visa">
                <img src="../Customer/image/tng.jpg" alt="TnG">
            </div>
        </div>
    </section>
